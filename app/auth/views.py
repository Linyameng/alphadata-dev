...
def favicon():
    return send_from_directory(os.path.join(auth.root_path, 'static'),'20181102045911705.ico', mimetype='image/vnd.microsoft.icon')
...
def login():
    ...
    if form.validate_on_submit():
        ...
        flash('无效用户名或是密码.')
    return render_template('auth/login.html', form=form ,bb =0)
